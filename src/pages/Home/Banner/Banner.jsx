...
const Banner = () => {
  ...
  return (
    <div className="h-screen">
      ...
      >
        <div className="order-last md:order-first" data-aos="fade-down-right">
          ...
          <div>
            <p className="max-w-[40ch] xl:max-w-[50ch] ml-6 mt-6 text-gray-400 font-semibold">
              {" "}
              As a programmer, one should never cease learning, for continuous
              learning and practice are the cornerstones of achieving perfection
              in programming.
            </p>
          </div>
        ...
        <div className="flex items-center " id="_ActiveAvatar_NavigateUI">
          ...
          >
            <img
              className="size-[300px]  xl:size-[500px] bg-textPrimary object-cover rounded-full"
              src={myImage}
              alt="Image"
            />
            <span className="size-5 bg-emerald-600 absolute rounded-full bottom-5 xl:bottom-9 right-9 xl:right-20 border-[3px] border-white"></span>
            <span className="size-5 bg-emerald-600 absolute rounded-full bottom-5 xl:bottom-9 right-9 xl:right-20 animate-ping"></span>
          </div>
        </div>
      </div>
