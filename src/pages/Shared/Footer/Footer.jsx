		...
		>
			<div className="pt-6 ">
				...
				<div className="grid md:grid-cols-2 lg:grid-cols-3 place-items-center -mt-16 gap-10 md:gap-20 mx-6">
					<div className="bg-textSecondary p-6 px-16 rounded-xl">
						...
						<div className="flex flex-col gap-10">
							<div className="relative  w-max rounded-lg">
								<input
									className="peer rounded-xl border-4 border-textPrimary bg-textSecondary px-4 py-2 text-white focus:outline-none"
									type="text"
						...
						{/* Button */}
						<button className="py-2 w-full h-16 px-6 mb-4 mt-6 bg-textPrimary hover:bg-emerald-300 duration-300 text-textSecondary font-bold text-xl rounded-xl flex items-center justify-center overflow-hidden hover:overflow-visible relative group">
							<svg
